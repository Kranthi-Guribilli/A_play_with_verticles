...
public class DeviceServiceVertxProxyHandler extends ProxyHandler {
  ...
  public DeviceServiceVertxProxyHandler(Vertx vertx, DeviceService service, boolean topLevel, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond, false);
  }

  public DeviceServiceVertxProxyHandler(Vertx vertx, DeviceService service, boolean topLevel, long timeoutSeconds, boolean includeDebugInfo) {
      this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "getDeviceById": {
          service.getDeviceById((java.lang.String)json.getValue("deviceId"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "addDevice": {
          service.addDevice((io.vertx.core.json.JsonObject)json.getValue("device"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "updateDevice": {
          service.updateDevice((io.vertx.core.json.JsonObject)json.getValue("device"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "deleteDevice": {
